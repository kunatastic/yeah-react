...
export default function Modal(props: {
  ...
  const { open, children, onCloseCB } = props;
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={onCloseCB}>
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <Dialog.Overlay className="fixed inset-0 bg-blue-700 blur-3xl bg-opacity-75 transition-opacity" />
          </Transition.Child>
